                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sku" class="form-control @error('sku') is-invalid @enderror"
                                name="sku" value="{{ old('sku')?old('sku'):'' }}" required>
                            @error('sku')
                            <span class="text-danger">
                                {{ $errors->first('sku') }}
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="regular_price"
                                ...
                                value="{{ old('regular_price')?old('regular_price'):'' }}" required>
                            @error('regular_price')
                            <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="features" id="features">{{ old('features')?old('features'):'' }}</textarea>
                            @error('features')
                            <span class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="stock" class="form-control @error('stock') is-invalid @enderror"
                                name="stock" value="{{ old('stock')?old('stock'):'' }}">
                            @error('stock')
                            <span class="text-danger">
                                {{ $errors->first('stock') }}
                            </span>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="local" role="tabpanel"
                                                    ...
                                                    <p class="text-center">
                                                        <div class="form-group">
                                                            <input type="file" class="form-control" name="product_image_from_local[]" accept="image/*" multiple>
                                                            <span class="text-muted">
