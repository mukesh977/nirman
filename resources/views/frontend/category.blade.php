...
<section class="inner-category">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-12 order-lg-1 order-md-1 order-sm-2 order-2 cat-left">
                ...
                <div class="inner-category-list">
                    ...
                    <form action="#" class="inner-category-form" _lpchecked="1">
                        {{-- <div class="inner-category-list-search list-form">
                            <label>Search</label>
                            <input class="form-control" type="text" value="" size="50" autocomplete="off"
                                placeholder="Search" name="search">
                        </div>
                        <div class="inner-category-list-brands list-form">
                            <label>Brand</label>
                            <ul class="checkboxes_list">
                                <li>
                                    <input type="checkbox" checked="" name="brand" id="brand_1">
                                    <label for="brand_1">Brand 1</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_2">
                                    <label for="brand_2">Brand 2</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_3">
                                    <label for="brand_3">Brand 3</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_4">
                                    <label for="brand_4">Brand 4</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_5">
                                    <label for="brand_5">Brand 5</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_6">
                                    <label for="brand_6">Brand 6</label>
                                </li>
                            </ul>
                        </div>
                        <div class="inner-category-list-price list-form">
                            ...
                            <ul class="checkboxes_list">
                                <li>
                                    <input type="checkbox" checked="" name="brand" id="brand_1">
                                    <label for="brand_1">$5-$10</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_2">
                                    <label for="brand_2">$10-$50</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_3">
                                    <label for="brand_3">$50-$500</label>
                                </li>
                                <li>
                                    <input type="checkbox" name="brand" id="brand_4">
                                    <label for="brand_4">$500-$1000</label>
                                </li>
                            </ul>
                        </div> --}}
                            ...
                            <div class="inner-category-view-sort">
                                <div class="inner-listing-sort">
                                    ...
                                    <select onchange="location = this.value;">
                                        <option
                                            value="{{ route('frontend.category.show',['cat' => $product_category->slug, 'filter'=>'default']) }}">
                                            Default</option>
                                        <option
                                            value="{{ route('frontend.category.show',['cat' => $product_category->slug,'filter'=>'latest']) }}"
                                            {{ ($filter == 'latest')?'selected':'' }}>
                                            New Arriaval</option>
                                        <option
                                            value="{{ route('frontend.category.show',['cat' => $product_category->slug,'filter'=>'price_asc']) }}"
                                            {{ ($filter == 'price_asc')?'selected':'' }}>
                                            Price (Low to High)</option>
                                        <option
                                            value="{{ route('frontend.category.show',[ 'cat' => $product_category->slug,'filter'=>'price_desc']) }}"
                                            {{ ($filter == 'price_desc')?'selected':'' }}>
