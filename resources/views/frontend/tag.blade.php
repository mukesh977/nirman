                    ...
                    <form action="#" class="inner-category-form" _lpchecked="1">
                        <div class="inner-category-list-tags list-form">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('frontend.tag.show', $item->tag) }}"
                                        class="{{ ($tag == $item->tag)?'active':'' }}"> {{ $item->tag }}</a>
                                </li>
                                @endforeach
                                @endif
                            </ul>
                            ...
                            <div class="inner-category-view-sort">
                                <div class="inner-listing-sort">
                                    ...
                                    <select onchange="location = this.value;">
                                        <option
                                            value="{{ route('frontend.tag.show',['tag' => $product_tag->tag, 'filter'=>'default']) }}">
                                            Default</option>
                                        <option
                                            value="{{ route('frontend.tag.show',['tag' => $product_tag->tag,'filter'=>'latest']) }}"
                                            {{ ($filter == 'latest')?'selected':'' }}>
                                            New Arriaval</option>
                                        <option
                                            value="{{ route('frontend.tag.show',['tag' => $product_tag->tag,'filter'=>'price_asc']) }}"
                                            {{ ($filter == 'price_asc')?'selected':'' }}>
                                            Price (Low to High)</option>
                                        <option
                                            value="{{ route('frontend.tag.show',[ 'tag' => $product_tag->tag,'filter'=>'price_desc']) }}"
